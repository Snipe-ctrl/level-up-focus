            ...
            <div className="fixed w-screen h-screen bg-neutral-900 shadow-xl py-8 flex items-center justify-center">
                <div className="hidden md:flex items-center justify-center w-320 h-full rounded-2xl border border-white/30 ml-16 mr-4 px-8"
                    ...
                    <div className="flex flex-col items-center text-center">
                        <Image 
                            ...
                            height={200}
                        />
                        <h2 className="text-white text-4xl font-bold mb-4">Level Up Your Productivity</h2>
                ...
                <div className="bg-neutral-900 w-full h-full flex items-center justify-center font-bold mx-4 px-6">
                    <div className="flex justify-start flex-col w-100">
                        <h2 className="text-white text-3xl text-center md:text-left mb-2">Sign Up</h2>
                        <div className="flex justify-center md:justify-start gap-1 mb-6">
                            <p className="text-neutral-400 font-light text-sm p-0 justify-center md:justify-start">Already have an account? </p>
                            <Link href="/" className="text-[#49ae2f] font-medium text-sm hover:cursor-pointer hover:text-[#77e35a]">
                                Sign In
                            </Link>
                        </div>
                        <div className="flex items-center justify-start flex-col gap-3 mb-3 w-full">
                            <Input
                                className=""
                                ref={usernameRef} 
                        ...
                        <div className="flex justify-start items-center mb-8">
                            <input
                                ...
                                type="checkbox"
                            />
                            <p className="text-white text-sm font-light mr-1">I agree to the</p>
                            <Link href="/">
                                <p className="text-white text-sm font-light underline">Terms and Conditions</p>
                            </Link>
                        </div>
                        <Button className="w-full mb-6" variant="green">Sign Up</Button>
                        <div className="flex items-center justify-between mb-4">
                            <div className="w-[30%] h-[0.5px] bg-neutral-400"></div>
                            <p className="text-[13px] text-neutral-400 font-light">Or register with</p>
